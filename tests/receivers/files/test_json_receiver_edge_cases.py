...
class TestJSONReceiverErrorHandling:
    ...
    @pytest.mark.asyncio
    async def test_write_row_type_validation(self, tmp_path: Path, metrics: ComponentMetrics):
    ...
    @pytest.mark.asyncio
    async def test_write_row_flat_paths_rejection(self, tmp_path: Path, metrics: ComponentMetrics):
    ...
    @pytest.mark.asyncio
    async def test_read_bulk_file_not_found(self, metrics: ComponentMetrics, tmp_path: Path):
    ...
    @pytest.mark.asyncio
    async def test_read_row_file_not_found(self, metrics: ComponentMetrics, tmp_path: Path):
    ...
    @pytest.mark.asyncio
    async def test_read_bigdata_file_not_found(self, metrics: ComponentMetrics, tmp_path: Path):
...
class TestJSONReceiverMalformedData:
    ...
    @pytest.mark.asyncio
    async def test_read_bulk_malformed_json(self, tmp_path: Path, metrics: ComponentMetrics):
    ...
    @pytest.mark.asyncio
    async def test_read_row_ndjson_with_errors(self, tmp_path: Path, metrics: ComponentMetrics):
    ...
    @pytest.mark.asyncio
    async def test_read_bulk_ndjson_with_errors(self, tmp_path: Path, metrics: ComponentMetrics):
...
class TestJSONReceiverWriteOperations:
    ...
    @pytest.mark.asyncio
    async def test_write_bulk_error_handling(self, tmp_path: Path, metrics: ComponentMetrics):
        ...
        with patch('etl_core.receivers.files.json.json_receiver.dump_records_auto') as mock_dump:
    ...
    @pytest.mark.asyncio
    async def test_write_row_error_handling(self, tmp_path: Path, metrics: ComponentMetrics):
        ...
        with patch('etl_core.receivers.files.json.json_receiver.append_ndjson_record') as mock_append:
    ...
    @pytest.mark.asyncio
    async def test_write_bigdata_error_handling(self, tmp_path: Path, metrics: ComponentMetrics):
        ...
        with patch('etl_core.receivers.files.json.json_receiver.dask.compute') as mock_compute:
            ...
            # The error count might be incremented twice due to the outer exception handler
            assert metrics.error_count >= 1

    @pytest.mark.asyncio
    async def test_write_bigdata_outer_exception(self, tmp_path: Path, metrics: ComponentMetrics):
...
class TestJSONReceiverBigDataOperations:
    ...
    @pytest.mark.asyncio
    async def test_read_bigdata_json_to_ndjson_conversion_error(self, tmp_path: Path, metrics: ComponentMetrics):
    ...
    @pytest.mark.asyncio
    async def test_read_bigdata_compute_error_handling(self, tmp_path: Path, metrics: ComponentMetrics):
        ...
        with patch('etl_core.receivers.files.json.json_receiver.dd.read_json') as mock_read:
    ...
    @pytest.mark.asyncio
    async def test_read_bigdata_directory_input(self, tmp_path: Path, metrics: ComponentMetrics):
    ...
    @pytest.mark.asyncio
    async def test_write_bigdata_gzip_output(self, tmp_path: Path, metrics: ComponentMetrics):
...
class TestJSONReceiverSpecialCases:
    ...
    @pytest.mark.asyncio
    async def test_read_bulk_empty_dataframe(self, tmp_path: Path, metrics: ComponentMetrics):
    ...
    @pytest.mark.asyncio
    async def test_write_row_ndjson_append(self, tmp_path: Path, metrics: ComponentMetrics):
    ...
    @pytest.mark.asyncio
    async def test_write_row_json_array_append(self, tmp_path: Path, metrics: ComponentMetrics):
    ...
    @pytest.mark.asyncio
    async def test_read_bulk_single_object(self, tmp_path: Path, metrics: ComponentMetrics):
    ...
    @pytest.mark.asyncio
    async def test_read_row_single_object(self, tmp_path: Path, metrics: ComponentMetrics):
    ...
    @pytest.mark.asyncio
    async def test_metrics_tracking_accuracy(self, tmp_path: Path, metrics: ComponentMetrics):
