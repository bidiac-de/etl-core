...
class TestRealDatabaseConnection:
    ...
    @pytest.fixture
    def persisted_real_credentials(self) -> Tuple[Credentials, str]:
        """
        Persist real Credentials and return (model, credentials_id).
        IDs are system-generated by the handler.
        Note: adjust the connection details to your test database setup.
        """
        creds = Credentials(
            name="local_mariadb",
            user="root",
    ...
    def test_can_connect_to_database(self, persisted_real_credentials):
    ...
    @pytest.mark.skip(reason="manually deactivated right now")
    def test_can_read_from_database(
        self,
        persisted_real_credentials,
        test_table_name,
    ...
    def test_database_operations_workflow(
        self, persisted_real_credentials, test_table_name
    ):
    ...
    def test_connection_error_handling(self):
        ...
        try:
            ...
            print(
                "WARNING: Invalid credentials were accepted! This "
            ...
            with handler.lease() as connection:
                ...
                result = connection.execute(_text("SELECT USER() as current_user"))
                row = result.fetchone()
    ...
    @pytest.mark.skip(reason="manually deactivated right now")
    def test_show_test_data(self, persisted_real_credentials):
        ...
        try:
            ...
            with handler.lease() as connection:
                ...
                if "test_connection_table" in tables:
                    ...
                    print("\nTable structure of 'test_connection_table':")
                    for col in columns:
                        print(
                            f"   {col[0]} | {col[1]} | {col[2]} "
                            f"| {col[3]} | {col[4]} | {col[5]}"
    ...
    @pytest.mark.skip(reason="manually deactivated right now")
    def test_cleanup_test_data(self, persisted_real_credentials):
