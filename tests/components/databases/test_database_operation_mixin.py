...
class TestDatabaseOperationMixin:
    ...
    def test_build_query_insert(self):
        ...
        component = DatabaseOperationMixinComponent(operation=DatabaseOperation.INSERT)
    ...
    def test_build_query_upsert(self):
        ...
        component = DatabaseOperationMixinComponent(operation=DatabaseOperation.UPSERT)
    ...
    def test_build_query_truncate(self):
        ...
        expected = (
            ...
            "(id, name, status) VALUES (:id, :name, :status)"
        )
    ...
    def test_build_query_update_with_conditions(self):
        ...
        expected = (
            ...
            "status = :status WHERE id = :id_filter AND status = 'active'"
        )
    ...
    def test_build_query_update_without_conditions(self):
        ...
        with pytest.raises(
            ValueError, match="UPDATE operation requires where_conditions"
        ):
    ...
    def test_build_query_update_single_condition(self):
        ...
        component = DatabaseOperationMixinComponent(
            operation=DatabaseOperation.UPDATE, where_conditions=["id = :target_id"]
        )
